...
export default function RmpmMap({ candidate, candidates, initialTheme, onSource, onMethodology }) {
  ...
  return <div className="rmpm-explorer">
    ...
    <div className="map-alert compact-alert editorial-position-note"><strong>位置の違いから、「なぜ？」を見つける。</strong><span>公開資料と公開された分類基準をもとに、運営主体が編集上の相対的位置として整理しています。</span></div>

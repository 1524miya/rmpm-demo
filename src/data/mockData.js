...
export const regions = [
  ...
  {id:'rina',name:'利名市',items:[['本会議議事録','公開'],['委員会議事録','一部公開'],['質疑・答弁記録','一部公開'],['議員別活動記録','一部あり'],['公開資料の検索性','PDFのみ'],['更新状況','更新遅れ']],note:'検索と更新に制約があり、同じ条件で活動記録を確認できない場合があります。'},
  {id:'wakabano',name:'若葉野市',items:[['本会議議事録','公開'],['委員会議事録','未公開'],['質疑・答弁記録','一部公開'],['議員別活動記録','なし'],['公開資料の検索性','検索困難'],['更新状況','不明']],note:'委員会議事録が未公開のため、活動を確認できない原因が地域側の公開状況にある場合があります。'},
];
